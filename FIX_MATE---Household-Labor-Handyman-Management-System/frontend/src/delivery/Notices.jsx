...
const DeliveryNotices = () => {
  ...
  const fetchNotices = useCallback(async () => {
    try {
      ...
      const { data } = await axios.get(backendUrl + '/api/delivery/notices', { withCredentials: true });
  ...
  const markRead = useCallback(async (id) => {
    try {
      await axios.post(backendUrl + `/api/delivery/notices/${id}/read`, {}, { withCredentials: true });
