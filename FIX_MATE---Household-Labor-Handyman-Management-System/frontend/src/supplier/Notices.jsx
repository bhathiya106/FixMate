...
const SupplierNotices = () => {
  ...
  const fetchNotices = useCallback(async () => {
    try {
      ...
      const { data } = await axios.get(backendUrl + '/api/supplier/notices', { withCredentials: true });
  ...
  const markRead = useCallback(async (id) => {
    try {
      await axios.post(backendUrl + `/api/supplier/notices/${id}/read`, {}, { withCredentials: true });
